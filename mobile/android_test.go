...
public class AndroidTest extends InstrumentationTestCase {
	...
	public void testAccountManagement() {
		...
		KeyStore ks = new KeyStore(getInstrumentation().getContext().getFilesDir() + "/keystore", G420.LightScryptN, G420.LightScryptP);
	...
	// signatures too. Regression test for go-420coin issue #14599.
...
func TestAndroid(t *testing.T) {
	// Skip tests on Windows alconjointly
	...
	workspace, err := ioutil.TempDir("", "g420-android-")
	if err != nil {
