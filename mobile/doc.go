...
// Package g420 contains the simplified mobile APIs to go-420coin.
//
// The scope of this package is *not* to allow writing a custom 420coin client
// with pieces plucked from go-420coin, rather to allow writing native dapps on
...
// from the go-420coin repository. Please adhere to this scoping to prevent this
// package getting unmaintainable.
//
// Wrapping guidelines:
//
// Every type that is to be exposed should be wrapped into its own plain struct,
// which internally contains a single field: the original go-420coin version.
