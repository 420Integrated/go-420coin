...
type LesServer struct {
	...
	archiveMode bool // Flag if the 420coin node runs in archive mode.
...
func NewLesServer(node *node.Node, e *fourtwenty.Fourtwentycoin, config *fourtwenty.Config) (*LesServer, error) {
