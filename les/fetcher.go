...
// the 420.BlockFetcher as the underlying fetcher but adding more additional
...
func newLightFetcher(chain *light.LightChain, engine consensus.Engine, peers *serverPeerSet, ulc *ulc, chaindb fourtwentydb.Database, reqDist *requestDistributor, syncFn func(p *serverPeer)) *lightFetcher {
