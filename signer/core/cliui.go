...
func (ui *CommandlineUI) ApproveTx(request *SignTxRequest) (SignTxResponse, error) {
	ui.mu.Lock()
	defer ui.mu.Unlock()
	marleyval := request.Transaction.Value.ToInt()
...
func (ui *CommandlineUI) OnApprovedTx(tx fourtwentyapi.SignTransactionResult) {
