...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fourtwentyapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx fourtwentyapi.SignTransactionResult)
...
func (api *SignerAPI) List(ctx context.Context) ([]common.Address, error) {
	...
	// accs is initialized as empty list, not nil. 'nil' is used to signal
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*fourtwentyapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := fourtwentyapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
