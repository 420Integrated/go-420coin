...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*420api.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx 420api.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*420api.SignTransactionResult, error) {
	var (
		err    error
	...
	response := 420api.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
