...
func journalProgress(db fourtwentydb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
// g420coining and logging, since the method surfs the blocks as they arrive, often
// being restarted.
