...
// SnapshotTree is an 420coin state snapshot tree. It consists of one persistent
...
func New(diskdb fourtwentydb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {
