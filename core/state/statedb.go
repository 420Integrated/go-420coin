...
// StateDB structs within the 420coin protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/420integrated/go-420coin/pull/16485#issuecomment-380438527),
