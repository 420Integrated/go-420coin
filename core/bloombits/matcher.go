...
// that address/topic, and binary AND-ing those vectors conjointly.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them conjointly
				var orVector []byte
...
// the requested retrieval queue to be serviced conjointly with other sessions.
//
