...
func ReadSnapshotRoot(db fourtwentydb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db fourtwentydb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db fourtwentydb.KeyValueWriter) {
...
func ReadAccountSnapshot(db fourtwentydb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db fourtwentydb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db fourtwentydb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db fourtwentydb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db fourtwentydb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db fourtwentydb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db fourtwentydb.Iteratee, accountHash common.Hash) fourtwentydb.Iterator {
	return db.NewIterator(storageSnapshotsKey(accountHash), nil)
}

// ReadSnapshotJournal retrieves the serialized in-memory diff layers saved at
// the last shutdown. The blob is expected to be max a few 10s of megabytes.
func ReadSnapshotJournal(db fourtwentydb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db fourtwentydb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db fourtwentydb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db fourtwentydb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db fourtwentydb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db fourtwentydb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db fourtwentydb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db fourtwentydb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db fourtwentydb.KeyValueWriter) {
...
func ReadSanpshotSyncStatus(db fourtwentydb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db fourtwentydb.KeyValueWriter, status []byte) {
...
// shutdown
func DeleteSnapshotSyncStatus(db fourtwentydb.KeyValueWriter) {
