...
func writeTxLookupEntry(db fourtwentydb.KeyValueWriter, hash common.Hash, numberBytes []byte) {
...
// a list of hashes
func WriteTxLookupEntries(db fourtwentydb.KeyValueWriter, number uint64, hashes []common.Hash) {
...
func WriteTxLookupEntriesByBlock(db fourtwentydb.KeyValueWriter, block *types.Block) {
...
func DeleteTxLookupEntries(db fourtwentydb.KeyValueWriter, hashes []common.Hash) {
	for _, hash := range hashes {
