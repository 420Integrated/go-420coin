...
// NewID calculates the 420coin fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the 420coin fork ID from existing chain instance.
