...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "g420.ipc", false, filepath.Join(os.TempDir(), "g420.ipc")},
		{"data", "g420.ipc", false, "data/g420.ipc"},
		{"data", "./g420.ipc", false, "./g420.ipc"},
		{"data", "/g420.ipc", false, "/g420.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "g420.ipc", true, `\\.\pipe\g420.ipc`},
		{"data", "g420.ipc", true, `\\.\pipe\g420.ipc`},
		{"data", `\\.\pipe\g420.ipc`, true, `\\.\pipe\g420.ipc`},
	}
