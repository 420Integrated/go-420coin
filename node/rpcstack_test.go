...
func TestWebsocketOrigins(t *testing.T) {
	tests := []originTest{
		{
			spec: "*", // allow all
			expOk: []string{"", "http://test", "https://test", "http://test:6174", "https://test:6174",
				"http://test.com", "https://foo.test", "http://testa", "http://atestb:6174", "https://atestb:8540"},
		},
		{
			spec:    "test",
			expOk:   []string{"http://test", "https://test", "http://test:6174", "https://test:6174"},
			expFail: []string{"http://test.com", "https://foo.test", "http://testa", "http://atestb:6174", "https://atestb:8540"},
		},
		// scheme tests
		{
			spec:  "https://test",
			...
			expFail: []string{
				...
				"http://testx:6174", "https://xtest:6174"},
		},
		// ip tests
		{
			spec:  "https://12.34.56.78",
			expOk: []string{"https://12.34.56.78", "https://12.34.56.78:6174"},
			expFail: []string{
				...
				"https://87.65.43.21", "http://87.65.43.21:6174", "https://87.65.43.21:6174"},
		},
		// port tests
		{
			spec:  "test:6174",
			expOk: []string{"http://test:6174", "https://test:6174"},
			expFail: []string{
				"http://test", "https://test", // spec says port required
				"http://test:6175", "https://test:6175", // wrong port
				"http://bad", "https://bad", "http://bad:6174", "https://bad:6174"},
		},
		// scheme and port
		{
			spec:  "https://test:6174",
			expOk: []string{"https://test:6174"},
			expFail: []string{
				"https://test",                          // missing port
				"http://test",                           // missing port, + wrong scheme
				"http://test:6174",                      // wrong scheme
				"http://test:6175", "https://test:6175", // wrong port
				"http://bad", "https://bad", "http://bad:6174", "https://bad:6174"},
		},
