...
var (
	...
	maxQueuedHeaders            = 32 * 1024                         // [fourtwenty/62] Maximum number of headers to queue for import (DOS protection)
...
type Downloader struct {
	...
	stateCh        chan dataPack // [fourtwenty/63] Channel receiving inbound node state data
