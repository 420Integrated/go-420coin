...
// Syncing provides information when this nodes starts synchronising with the 420coin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  fourtwentycoin.SyncProgress `json:"status"`
}
