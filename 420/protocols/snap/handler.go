...
func handleMessage(backend Backend, peer *Peer) error {
	...
	case msg.Code == GetStorageRangesMsg:
		...
		// TODO: Do we want to enforce > 0 accounts and 1 account if origin is set?
		// TODO: - Logging locally is not ideal as remote faulst annoy the local user
		// TODO: - Dropping the remote peer is less flexible wrt client bugs (slow is better than non-functional)
