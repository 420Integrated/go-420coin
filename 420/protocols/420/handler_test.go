...
var (
	...
	// testAddr is the 420coin address of the tester account.
	testAddr = crypto.PubkeyToAddress(testKey.PublicKey)
)

// testBackend is a mock implementation of the live 420coin message handler. Its
// purpose is to allow testing the request/reply workflows and wire serialization
// in the `fourtwenty` protocol without actually doing any data processing.
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	// Create a chain generator with some simple transactions 
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some 420coins.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more 420coins to account #1.
