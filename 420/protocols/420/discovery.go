...
// enrEntry is the ENR entry which advertises `fourtwenty` protocol on the discovery.
...
// StartENRUpdater starts the `fourtwenty` ENR updater loop, which listens for chain
