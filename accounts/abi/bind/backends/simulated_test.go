...
func TestSimulatedBackend(t *testing.T) {
	...
	auth, _ := bind.NewKeyedTransactorWithChainID(key, big.NewInt(13370))
...
func TestSimulatedBackend_EstimateSmoke(t *testing.T) {
	...
	opts, _ := bind.NewKeyedTransactorWithChainID(key, big.NewInt(13370))
...
func TestSimulatedBackend_EstimateSmokeWithPrice(t *testing.T) {
	...
	var cases = []struct {
		...
		{"EstimateWithVeryHighPrice", fourtwentycoin.CallMsg{
			...
			To:       &recipient,
			Smoke:      0,
			SmokePrice: big.NewInt(1e14), // smokecost = 2.1420coin
			Value:    big.NewInt(1e17), // the remaining balance for fee is 2.1420coin
			Data:     nil,
		}, 21000, nil},
...
func TestSimulatedBackend_PendingCodeAt(t *testing.T) {
	...
	auth, _ := bind.NewKeyedTransactorWithChainID(testKey, big.NewInt(13370))
...
func TestSimulatedBackend_PendingAndCallContract(t *testing.T) {
	...
	contractAuth, _ := bind.NewKeyedTransactorWithChainID(testKey, big.NewInt(13370))
