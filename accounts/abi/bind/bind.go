...
//
// Detailed usage document and tutorial available on the go-420coin Wiki page:
// https://github.com/420integrated/go-420coin/wiki/Native-DApps:-Go-bindings-to-420coin-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// conjointly here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two conjointly so that if kind.TupleRawName
