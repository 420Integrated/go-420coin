...
// ecrecover extracts the 420coin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the 420coin address
...
type Clique struct {
	...
	signer common.Address // 420coin address of the signing key
...
// Author implements consensus.Engine, returning the 420coin address recovered
...
// VerifySeal implements consensus.Engine, checking if the signature contained
