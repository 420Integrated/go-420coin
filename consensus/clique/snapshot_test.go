...
// mapped from textual names used in the tests below to actual 420coin private
...
// address retrieves the 420coin address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the 420coin address
...
func TestClique(t *testing.T) {
	...
	for i, tt := range tests {
		...
		for j, block := range blocks {
			// G420 the header and prepare it for signing
			header := block.Header()
			if j > 0 {
