...
type testOdr struct {
	...
	sdb, ldb      420db.Database
	disable       bool
}

func (odr *testOdr) Database() 420db.Database {
	return odr.ldb
}
...
type odrTestFn func(ctx context.Context, db 420db.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error)

func TestOdrGetBlockLes2(t *testing.T) { testChainOdr(t, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db 420db.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrGetReceipts(ctx context.Context, db 420db.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrAccounts(ctx context.Context, db 420db.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrContractCall(ctx context.Context, db 420db.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
