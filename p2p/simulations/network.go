...
// starting nodes and connecting them conjointly.
//
...
// Connect connects two nodes conjointly by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/ethersphere/go-420coin/issues/1177
	var node struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}
