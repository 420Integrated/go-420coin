...
creating a collection of devp2p nodes, connecting them conjointly to form a
...
connecting two nodes conjointly).
...
As a concrete example, consider a simulated network of 420coin nodes. An
