...
func New(stack *node.Node, backend 420api.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend 420api.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
