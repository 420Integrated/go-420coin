...
func (t *Transaction) SmokeUsed(ctx context.Context) (*hexutil.Uint64, error) {
	receipt, err := t.getReceipt(ctx)
	if err != nil || receipt == nil {
		return nil, err
	}
	ret := hexutil.Uint64(receipt.SmokeUsed)
	return &ret, nil
}

func (t *Transaction) CumulativeSmokeUsed(ctx context.Context) (*hexutil.Uint64, error) {
	receipt, err := t.getReceipt(ctx)
	if err != nil || receipt == nil {
		return nil, err
	}
	ret := hexutil.Uint64(receipt.CumulativeSmokeUsed)
	return &ret, nil
}
...
// Block represents an 420coin block.
...
func (b *Block) SmokeLimit(ctx context.Context) (hexutil.Uint64, error) {
	header, err := b.resolveHeader(ctx)
	if err != nil {
		return 0, err
	}
	return hexutil.Uint64(header.SmokeLimit), nil
}

func (b *Block) SmokeUsed(ctx context.Context) (hexutil.Uint64, error) {
	header, err := b.resolveHeader(ctx)
	if err != nil {
		return 0, err
	}
	return hexutil.Uint64(header.SmokeUsed), nil
}
...
type CallResult struct {
	...
	smokeUsed hexutil.Uint64 // The amount of smoke used
...
func (c *CallResult) SmokeUsed() hexutil.Uint64 {
	return c.smokeUsed
}
...
func (b *Block) Call(ctx context.Context, args struct {
	...
	return &CallResult{
		...
		smokeUsed: hexutil.Uint64(result.UsedSmoke),
		status:  status,
	}, nil
}
