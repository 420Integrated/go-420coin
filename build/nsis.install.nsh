Name "g420 ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
...
Section "G420" G420_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\g420.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\g420.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "G420 incoming peers (TCP:13013)"
  SimpleFC::AdvRemoveRule "G420 outgoing peers (TCP:13013)"
  SimpleFC::AdvRemoveRule "G420 UDP discovery (UDP:13013)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "G420 incoming peers (TCP:13013)" ""  6 1 1 2147483647 1 "$INSTDIR\g420.exe" "" "" "420coin" 13013 "" "" ""
  SimpleFC::AdvAddRule "G420 outgoing peers (TCP:13013)" ""  6 2 1 2147483647 1 "$INSTDIR\g420.exe" "" "" "420coin" "" 13013 "" ""
