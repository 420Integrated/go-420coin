...
# 1. install g420 for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for g420
# 5. create g420, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable 420COIN_SOCKET
...
!define GROUPNAME "420coin"
!define APPNAME "G420"
!define DESCRIPTION "Official Go implementation of the 420coin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since g420 is installed global
