...
import (
	...
	"github.com/420integrated/go-420coin/internal/jsre/deps"
	"github.com/420integrated/go-420coin/internal/web3ext"
...
// interaction. The original web3 callbacks are stored in 'j420'. These will be called
...
func (c *Console) initPersonal(vm *goja.Runtime, bridge *bridge) {
	...
	j420 := vm.NewObject()
	vm.Set("j420", j420)
	j420.Set("openWallet", personal.Get("openWallet"))
	j420.Set("unlockAccount", personal.Get("unlockAccount"))
	j420.Set("newAccount", personal.Get("newAccount"))
	j420.Set("sign", personal.Get("sign"))
...
// Welcome show summary of current G420 instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the G420 JavaScript console!\n\n"

	// Print some generic G420 metadata
