...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage 420coin presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    g420 wallet import /path/to/my/presale.wallet

will prompt for your password and imports your 420coin presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import 420coin presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	g420 wallet [options] /path/to/my/presale.wallet
...
between 420coin nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    g420 account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    g420 account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gfourtwentyConfig{Node: defaultNodeConfig()}
	// Load config file.
