...
// spawns g420 with the given command line args, using a set of flags to minimise
...
func TestConsoleWelcome(t *testing.T) {
	...
	g420 := runMinimalG420(t, "--fourtwentycoinbase", coinbase, "console")
...
func TestAttachWelcome(t *testing.T) {
	...
	p := trulyRandInt(1024, 65533) // Yeah, sometimes this will fail.
	httpPort = strconv.Itoa(p)
	wsPort = strconv.Itoa(p + 1)
	geth := runMinimalG420(t, "--fourtwentycoinbase", "0x8605cdbbdb6d264aa742e77020dcbc58fcdce182",
		"--ipcpath", ipc,
