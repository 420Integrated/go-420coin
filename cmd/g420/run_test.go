...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "g420-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "g420-test" in runG420.
	reexec.Register("g420-test", func() {
...
// spawns g420 with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runG420(t *testing.T, args ...string) *testg420 {
	tt := &testg420{}
	...
	// Boot "g420". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("g420-test", args...)
