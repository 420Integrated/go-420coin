...
func newClient(ctx *cli.Context) *420client.Client {
	client, err := 420client.Dial(ctx.GlobalString(nodeURLFlag.Name))
	if err != nil {
...
func newContract(client *rpc.Client) (common.Address, *checkpointoracle.CheckpointOracle) {
	...
	contract, err := checkpointoracle.NewCheckpointOracle(addr, 420client.NewClient(client))
	if err != nil {
