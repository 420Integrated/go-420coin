...
Currently, only the 420coin mainnet and the default supported test network (ropsten) activates this feature. If you want to activate this feature in your private network, you can overwrite the relevant checkpoint oracle settings through the configuration file after deploying the oracle contract.
