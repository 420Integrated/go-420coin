...
import (
	...
	"github.com/420integrated/go-420coin/signer/core"
	"github.com/420integrated/go-420coin/signer/fourbyte"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (2020=mainnet, 2020=Ruderalis)",
	}
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage 420coin account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("0x0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"420coin Mail","version":"1","chainId":"1","verifyingContract":"0xCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"0xcD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &fourtwentyapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
