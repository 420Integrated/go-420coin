...
Refactoring to operate with 420coin blockchain, gas->smoke, denomination changes.
...
* The external method `account_signTypedData` implements [EIP-712](https://github.com/420coin/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `fourtwenty_signTransaction`.
