...
// setting up a new or managing an existing 420coin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your 420coin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new 420coin network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and 420stats servers |")
	...
	log.Info("Administering 420coin network", "name", w.network)
