...
import (
	...
	"github.com/420integrated/go-420coin/common/compiler"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the 420coin contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the 420coin contract bytecode (generate deploy method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the 420coin contract Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the 420coin contract Vyper source to build and bind",
	}
