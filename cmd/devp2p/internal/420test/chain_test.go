...
// TestFourtwentyProtocolNegotiation tests whether the test suite
// can negotiate the highest fourtwenty protocol in a status message exchange
func TestFourtwentyProtocolNegotiation(t *testing.T) {
	var tests = []struct {
		conn     *Conn
		caps     []p2p.Cap
		expected uint32
		...
		},
		{
			conn: &Conn{},
			caps: []p2p.Cap{
				{Name: "fourtwenty", Version: 0},
				{Name: "fourtwenty", Version: 89},
				{Name: "fourtwenty", Version: 65},
			},
			expected: uint32(65),
		},
