...
func TestClientSubscribeInvalidArg(t *testing.T) {
	...
	check := func(shouldPanic bool, arg interface{}) {
		defer func() {
			...
			if !shouldPanic && err != nil {
				t.Errorf("FourtwentySubscribe shouldn't have panicked for %#v", arg)
...
// This test reproduces https://github.com/420integrated/go-420coin/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-420coin-test-ipc-%d-%d", os.Getpid(), rand.Int63())
