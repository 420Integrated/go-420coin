...
Audit reports are published in the `docs` folder: https://github.com/420integrated/go-420coin/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `g420` | 20170425 | [pdf](https://github.com/420integrated/go-420coin/blob/master/docs/audits/2017-04-25_G420-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/420integrated/go-420coin/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in 420coin visit [https://420integrated.com/contact/](https://420integrated.com/contact/) or email vulnerabilities@420integrated.com.
